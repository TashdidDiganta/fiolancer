...
do_action( 'arckytech_footer_style' );
?>
</div><!-- /.page-wrapper -->
<?php
    $mobile_nav_logo    = get_theme_mod('mobile_nav_logo', get_template_directory_uri() ."/assets/img/resources/logo-1.png");
    $mobile_nav_email   = get_theme_mod('mobile_nav_email', 'needhelp@arckytech.com');
...
<div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
        ...
        <div class="logo-box">
            <a href="<?php echo home_url(); ?>" aria-label="logo image"><img src="<?php echo esc_url($mobile_nav_logo); ?>" width="140" alt="<?php bloginfo('name'); ?>" /></a>
        </div>
        <!-- /.logo-box -->
