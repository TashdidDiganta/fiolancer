...
?>
    ...
    <div class="arc-blog-grid-meta">
        ...
        <?php if ( !empty($arckytech_blog_comments) ): ?>
        <span>
            <span>
                <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="<?php comments_link();?>"><?php echo esc_html__('Comments (', 'arckytec') ?><?php echo get_comments_number();?><?php echo esc_html__(')', 'arckytec') ?></a>
        </span>
        <?php endif;?>
