...
<div class="arc-blog-area arc-postbox-area pt-120 pb-120">
    <div class="container">
        <div class="row">
            <div class="<?php print esc_attr( $blog_column );?> blog-post-items">
            	<div class="arc-postbox-wrapper pr-50">
					...
					<div class="result-bar page-header d-none">
						<h1 class="page-title"><?php esc_html_e( 'Search Results For:', 'arckytec' );?> <?php print get_search_query();?></h1>
					</div>
					<?php
					...
					<div class="arc-pagination">
						<?php arckytech_pagination( '<i class="fas fa-angle-double-left"></i>', '<i class="fas fa-angle-double-right"></i>', '', [ 'class' => '' ] );?>
					</div>
					<?php
						else:
