...
$fio_blog_btn = get_theme_mod( 'fio_blog_btn', 'Read More' );
$fio_blog_btn_switch = get_theme_mod( 'fio_blog_btn_switch', true );

?>

<?php if ( !empty( $fio_blog_btn_switch ) ): ?>
<div class="postbox__read-more">
    <a href="<?php the_permalink();?>" class="nl-btn">
    <?php print esc_html( $fio_blog_btn );?>
