<?php
    ...
    $author_name = get_the_author_meta( 'fio_write_by');
    $facebook_url = get_the_author_meta( 'fio_facebook' );
    $twitter_url = get_the_author_meta( 'fio_twitter' );
    $linkedin_url = get_the_author_meta( 'fio_linkedin' );
    $instagram_url = get_the_author_meta( 'fio_instagram' );
    $fio_url = get_the_author_meta( 'fio_youtube' );
    $fio_write_by = get_the_author_meta( 'fio_write_by' );
    ...
    $fio_blog_view = get_theme_mod( 'fio_blog_view', false );
...
?>
    ...
    <div class="nl-blog-grid-meta">
        ...
        <?php if ( !empty($fio_blog_comments) ): ?>
        <span>
            <span>
                <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="<?php comments_link();?>"><?php echo esc_html__('Comments (', 'fio') ?><?php echo get_comments_number();?><?php echo esc_html__(')', 'fio') ?></a>
        </span>
        <?php endif;?>
