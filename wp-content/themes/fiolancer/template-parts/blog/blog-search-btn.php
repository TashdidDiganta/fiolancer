...
$fio_search_btn = get_theme_mod( 'fio_blog_btn', 'Read More' );
$fio_search_btn_switch = get_theme_mod( 'fio_blog_btn_switch', true );

?>


<?php if ( !empty( $fio_search_btn_switch ) ): ?>
<div class="nl-blog-grid-btn">
    <a href="<?php the_permalink();?>" class="nl-link-btn-3">
        <?php print esc_html( $fio_search_btn );?>
        <span>
