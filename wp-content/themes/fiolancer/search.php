            ...
            <div class="<?php print esc_attr( $blog_column );?> blog-post-items">
            	<div class="nl-postbox-wrapper pr-50">
					...
					<div class="result-bar page-header d-none">
						<h1 class="page-title"><?php esc_html_e( 'Search Results For:', 'fio' );?> <?php print get_search_query();?></h1>
					</div>
					<?php
					...
					<div class="nl-pagination">
						<?php fio_pagination( '<i class="fas fa-angle-double-left"></i>', '<i class="fas fa-angle-double-right"></i>', '', [ 'class' => '' ] );?>
					</div>
					<?php
						else:
