...
function nilos_get_allowed_html_desc($level = 'basic')
{
    ...
    return sprintf(__('This input field has support for the following HTML tags: %1$s', 'arc-core'), '<code>' . esc_html($tags_str) . '</code>');
}
...
trait NilosCoreElementFunctions
{
    ...
    protected function nilos_icon_style($control_id = null, $control_name = 'Icon/Image Style', $selector = '.single-service .icon'){
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__($control_name, 'arc-core'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Color', 'arc-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Background Color', 'arc-core'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Icon Size', 'arc-core' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Image/SVG Width', 'arc-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Image/SVG Height', 'arc-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px' ],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Bottom Spacing', 'arc-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Padding', 'arc-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'selectors' => [
    ...
    protected function nilos_basic_style_controls($control_id = null, $control_name = null, $control_selector = null)
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Typography', 'arc-core'),
                'selector' => '{{WRAPPER}} ' . $control_selector,
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Margin', 'arc-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Border Radius', 'arc-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
    ...
    protected function nilos_section_style_controls($control_id = null, $control_name = null, $control_selector = null)
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'arc-core'),
    ...
    */
    ...
    protected function nilos_link_controls_style($control_id = null, $control_name = null, $control_selector = null)
    {
        ...
        // Normal State Tab
        $this->start_controls_tab('nilos_' . $control_id . '_btn_normal', ['label' => esc_html__('Normal', 'arc-core')]);

        $this->add_control(
            'nilos_' . $control_id . '_btn_normal_text_color',
            [
                'label' => esc_html__('Text Color', 'arc-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Box Shadow', 'arc-core' ),
                'selector' => '{{WRAPPER}} ' . $control_selector . '',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Border Style', 'arc-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => esc_html__('Default', 'arc-core'),
                    'none' => esc_html__('None', 'arc-core'),
                    'solid' => esc_html__('Solid', 'arc-core'),
                    'double' => esc_html__('Double', 'arc-core'),
                    'dotted' => esc_html__('Dotted', 'arc-core'),
                    'dashed' => esc_html__('Dashed', 'arc-core'),
                    'groove' => esc_html__('Groove', 'arc-core'),
                ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Border Width', 'arc-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Border Color', 'arc-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        // Hover State Tab
        $this->start_controls_tab('nilos_' . $control_id . '_btn_hover', ['label' => esc_html__('Hover', 'arc-core')]);
    ...
    */
    ...
    protected function nilos_input_controls_style($control_id = null, $control_name = null, $control_selector = '.nilos-input', $control_selector2 = '.nilos-textarea')
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Placeholder Color', 'arc-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        // Focus State Tab
        $this->start_controls_tab('nilos_' . $control_id . '_btn_hover', ['label' => esc_html__('Focus', 'arc-core')]);
    ...
    */
    protected function nilos_button_render_controls($control_id = 'button', $control_name = 'Button', $control_condition = 'layout-1' ,  $default_btn_text = 'Read More', $default_btn_enable = 'yes')
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Show Button', 'arc-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' Text', 'arc-core'),
                'type' => Controls_Manager::TEXT,
                'default' => $default_btn_text,
                'title' => esc_html__('Enter button text', 'arc-core'),
                'label_block' => true,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' Link Type', 'arc-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '1' => 'Custom Link',
                    '2' => 'Internal Page',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__($control_name . ' link', 'arc-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Select ' . $control_name . ' Page', 'arc-core'),
    ...
    */
    protected function nilos_section_title_render_controls($control_id = null, $section_name = 'Section Title', $condition = ['layout-1', 'layout-2', 'layout-3', 'layout-4', 'layout-5', 'layout-6', 'layout-7', 'layout-8', 'layout-9', 'layout-10'] ,  $sub_title = 'Sub Title', $default_title = 'Your Section Title', $default_description = 'There are many variations of passages of Lorem Ipsum available, <br /> but the majority have suffered alteration.', $default_title_tag = 'h2', $default_align = 'text-left',  $enable_section_title_show_hide = true, $default_section_title_enable = 'yes')
    {
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__($section_name, 'arc-core'),
                'condition' => [
        ...
        if ($enable_section_title_show_hide){
            $this->add_control(
                ...
                [
                    'label' => esc_html__( 'Section Title & Content', 'arc-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Sub Title', 'arc-core'),
                'description' => nilos_get_allowed_html_desc( 'basic' ),
                'type' => Controls_Manager::TEXT,
                'default' => $sub_title,
                'placeholder' => esc_html__('Type Before Heading Text', 'arc-core'),
                'label_block' => true,
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title HTML Tag', 'arc-core'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'h1' => [
                        'title' => esc_html__('H1', 'arc-core'),
                        'icon' => 'eicon-editor-h1'
                    ],
                    'h2' => [
                        'title' => esc_html__('H2', 'arc-core'),
                        'icon' => 'eicon-editor-h2'
                    ],
                    'h3' => [
                        'title' => esc_html__('H3', 'arc-core'),
                        'icon' => 'eicon-editor-h3'
                    ],
                    'h4' => [
                        'title' => esc_html__('H4', 'arc-core'),
                        'icon' => 'eicon-editor-h4'
                    ],
                    'h5' => [
                        'title' => esc_html__('H5', 'arc-core'),
                        'icon' => 'eicon-editor-h5'
                    ],
                    'h6' => [
                        'title' => esc_html__('H6', 'arc-core'),
    ...
    */
    ...
    protected function nilos_columns($control_id = 'columns_options', $control_name = 'Select Columns', $default_for_lg = '4', $default_for_md = '6', $default_for_sm = '6', $default_for_all = '12'){
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Desktop', 'arc-core' ),
                'description' => esc_html__( 'Screen width equal to or greater than 1200px', 'arc-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'arc-core' ),
                    6 => esc_html__( '2 Columns', 'arc-core' ),
                    4 => esc_html__( '3 Columns', 'arc-core' ),
                    3 => esc_html__( '4 Columns', 'arc-core' ),
                    5 => esc_html__( '5 Columns (For Carousel Item)', 'arc-core' ),
                    2 => esc_html__( '6 Columns', 'arc-core' ),
                    1 => esc_html__( '12 Columns', 'arc-core' ),
                ],
                'separator' => 'before',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Large', 'arc-core' ),
                'description' => esc_html__( 'Screen width equal to or greater than 992px', 'arc-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'arc-core' ),
                    6 => esc_html__( '2 Columns', 'arc-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Tablet', 'arc-core' ),
                'description' => esc_html__( 'Screen width equal to or greater than 768px', 'arc-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'arc-core' ),
                    6 => esc_html__( '2 Columns', 'arc-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Mobile', 'arc-core' ),
                'description' => esc_html__( 'Screen width less than 767px', 'arc-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    12 => esc_html__( '1 Columns', 'arc-core' ),
                    6 => esc_html__( '2 Columns', 'arc-core' ),
    ...
    */
    protected function nilos_columns_carousel($control_id = 'carousel_columns_options', $control_name = 'Select Columns', $default_for_xl = '4', $default_for_lg = '4', $default_for_md = '3', $default_for_sm = '2', $default_for_all = '1', $default_for_xs = '1'){
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Extra Large Desktop', 'arc-core' ),
                'description' => esc_html__( 'Screen width equal to or greater than 1920px', 'arc-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'arc-core' ),
                    2 => esc_html__( '2 Columns', 'arc-core' ),
                    3 => esc_html__( '3 Columns', 'arc-core' ),
                    4 => esc_html__( '4 Columns', 'arc-core' ),
                    5 => esc_html__( '5 Columns', 'arc-core' ),
                    6 => esc_html__( '6 Columns', 'arc-core' ),
                    7 => esc_html__( '7 Columns', 'arc-core' ),
                    8 => esc_html__( '8 Columns', 'arc-core' ),
                    9 => esc_html__( '9 Columns', 'arc-core' ),
                    10 => esc_html__( '10 Columns', 'arc-core' ),
                    11 => esc_html__( '10 Columns', 'arc-core' ),
                    12 => esc_html__( '12 Columns', 'arc-core' ),
                ],
                'separator' => 'before',
        ...
        $this->add_control(
            'nilos_' . $control_id . '_for_laptop',
            [
                'label' => esc_html__( 'Columns for Laptop', 'arc-core' ),
                'description' => esc_html__( 'Screen width equal to or greater than 992px', 'arc-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'arc-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Mobile', 'arc-core' ),
                'description' => esc_html__( 'Screen width less than 767', 'arc-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'arc-core' ),
                    2 => esc_html__( '2 Columns', 'arc-core' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Columns for Extra Small Mobile', 'arc-core' ),
                'description' => esc_html__( 'Screen width less than 575px', 'arc-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    1 => esc_html__( '1 Columns', 'arc-core' ),
                    2 => esc_html__( '2 Columns', 'arc-core' ),
    ...
    */
    ...
    protected function nilos_button_render($control_id = null, $control_name = 'box', $control_condition = 'layout-1'){
        $this->start_controls_section(
           ...
           $this->add_control(
               ...
               [
                   'label' => esc_html__( 'Add '.$control_name.' link', 'arc-core' ),
                   'type' => \Elementor\Controls_Manager::SWITCHER,
           ...
           $this->add_control(
               ...
               [
                   ...
                   'type' => Controls_Manager::TEXT,
                   'default' => esc_html__('Button Text', 'arc-core'),
                   'title' => esc_html__('Enter button text', 'arc-core'),
                   'label_block' => true,
                   'condition' => [
           ...
           $this->add_control(
               ...
               [
                   'label' => esc_html__( ''.$control_name.' Link link', 'arc-core' ),
           ...
           $this->add_control(
               ...
               [
                   'label' => esc_html__( 'Select '.$control_name.' Link Page', 'arc-core' ),
    ...
    protected function nilos_query_controls($control_id = null, $control_name = null, $default_title_num = 6, $default_content_limit = '10', $post_type = 'any', $taxonomy = 'category', $posts_per_page = '6', $offset = '0', $orderby = 'date', $order = 'desc')
    {
        ...
        $this->start_controls_section(
            'arc-core' . $control_id . '_query',
            [
                'label' => sprintf(esc_html__('%s Query', 'arc-core'), $control_name),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__('Leave blank or enter -1 for all.', 'arc-core'),
        ...
        $this->add_control(
            'category',
            [
                'label' => esc_html__('Include Categories', 'arc-core'),
                'description' => esc_html__('Select a category to include or leave blank for all.', 'arc-core'),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
        ...
        $this->add_control(
            'exclude_category',
            [
                'label' => esc_html__('Exclude Categories', 'arc-core'),
                'description' => esc_html__('Select a category to exclude', 'arc-core'),
                'type' => Controls_Manager::SELECT2,
                'multiple' => true,
                'options' => nilos_get_categories($taxonomy),
                'label_block' => true
        ...
        $this->add_control(
            'post__not_in',
            [
                'label' => esc_html__('Exclude Item', 'arc-core'),
                'type' => Controls_Manager::SELECT2,
        ...
        $this->add_control(
            'offset',
            [
                'label' => esc_html__('Offset', 'arc-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => $offset,
            ]
        );
        $this->add_control(
            'orderby',
            [
                'label' => esc_html__('Order By', 'arc-core'),
                'type' => Controls_Manager::SELECT,
        ...
        $this->add_control(
            'order',
            [
                'label' => esc_html__('Order', 'arc-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'asc' 	=> esc_html__( 'Ascending', 'arc-core' ),
                    'desc' 	=> esc_html__( 'Descending', 'arc-core' )
                ],
                'default' => $order,
        ...
        $this->add_control(
            'ignore_sticky_posts',
            [
                'label' => esc_html__( 'Ignore Sticky Posts', 'arc-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'arc-core' ),
                'label_off' => esc_html__( 'No', 'arc-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Title Word Count', 'arc-core'),
                'description' => esc_html__('Set how many word you want to displa!', 'arc-core'),
                'type' => Controls_Manager::NUMBER,
        ...
        if ($post_type !== 'product') {
            $this->add_control(
                'nilos_post_content',
                [
                    'label' => __('Content', 'arc-core'),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __('Show', 'arc-core'),
                    'label_off' => __('Hide', 'arc-core'),
                    'return_value' => 'yes',
                    'default' => 'yes',
                ]
            );
            $this->add_control(
                ...
                [
                    'label' => __('Content Limit', 'arc-core'),
                    'type' => Controls_Manager::TEXT,
            ...
            $this->add_control(
                'nilos_post_button',
                [
                    'label' => __('Blog Button', 'arc-core'),
                    'type' => Controls_Manager::TEXT,
                    'label_block' => true,
                    'default' => __('Read More', 'arc-core'),
                    'dynamic' => [
                        'active' => true,
                    ],
                ]
    ...
    protected function nilos_post_layout($control_id = null, $control_name = null){
        $this->start_controls_section(
            'nilos_'. $control_id .'_',
            [
                'label' => sprintf(esc_html__('%s - Layout', 'arc-core'), $control_name),
            ]
        );
        $this->add_control(
            'nilos_design_style',
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Blog Slider 1', 'arc-core'),
                    'layout-2' => esc_html__('Blog Box', 'arc-core'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Dots?', 'arc-core'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'arc-core'),
                'label_off' => esc_html__('Hide', 'arc-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Arrow Icons?', 'arc-core'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'arc-core'),
                'label_off' => esc_html__('Hide', 'arc-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Infinite?', 'arc-core'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'arc-core'),
                'label_off' => esc_html__('No', 'arc-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Autoplay?', 'arc-core'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'arc-core'),
                'label_off' => esc_html__('No', 'arc-core'),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Autoplay Speed', 'arc-core'),
                'type' => Controls_Manager::TEXT,
                'default' => '2500',
                'title' => esc_html__('Enter autoplay speed', 'arc-core'),
                'label_block' => true,
                'condition' => array(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Filter?', 'arc-core'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'arc-core'),
                'label_off' => esc_html__('No', 'arc-core'),
                'return_value' => 'yes',
    ...
    protected function nilos_post_layout_2($control_id = null, $control_name = null){
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Blog Grid', 'arc-core'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->add_control(
         'enable_sidebar',
            [
                'label'        => esc_html__( 'Enable Sidebar ?', 'arc-core' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'arc-core' ),
                'label_off'    => esc_html__( 'Hide', 'arc-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Pagination', 'arc-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'arc-core' ),
                'label_off' => esc_html__( 'Hide', 'arc-core' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Height', 'arc-core' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => [ 'px', '%' ],
                'range' => [
                    'px' => [
    ...
    protected function nilos_post_carousel_col($control_id = null, $control_name = null){
        $this->start_controls_section(
            ...
            [
                'label' => sprintf(esc_html__('%s - Columns for Carousel', 'arc-core'), $control_name),
            ]
        );
    ...
    protected function nilos_price_currency($control_id = null, $control_name = 'Silver Plan'){
        ...
        $this->add_control(
            ''. $control_id .'_title',
         [
            'label'       => esc_html__( 'Price Title', 'arc-core' ),
            'type'        => \Elementor\Controls_Manager::TEXT,
            'default' => sprintf(esc_html__('%s', 'arc-core'), $control_name),
            'placeholder' => esc_html__( 'Your title here', 'arc-core' ),
         ]
        );
        ...
        $this->add_control(
            ''. $control_id .'_desc',
         [
           'label'       => esc_html__( 'Price Description', 'arc-core' ),
           'type'        => \Elementor\Controls_Manager::TEXTAREA,
           'rows'        => 10,
           'default'     => esc_html__( 'Free forever,! No credit card required.', 'arc-core' ),
           'placeholder' => esc_html__( 'Your Description Here', 'arc-core' ),
         ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Currency', 'arc-core'),
                'type' => Controls_Manager::SELECT,
                'label_block' => false,
                'options' => [
                    '' => __('None', 'arc-core'),
                    'baht' => '&#3647; ' . _x('Baht', 'Currency Symbol', 'arc-core'),
                    'bdt' => '&#2547; ' . _x('BD Taka', 'Currency Symbol', 'arc-core'),
                    'dollar' => '&#36; ' . _x('Dollar', 'Currency Symbol', 'arc-core'),
                    'euro' => '&#128; ' . _x('Euro', 'Currency Symbol', 'arc-core'),
                    'franc' => '&#8355; ' . _x('Franc', 'Currency Symbol', 'arc-core'),
                    'guilder' => '&fnof; ' . _x('Guilder', 'Currency Symbol', 'arc-core'),
                    'krona' => 'kr ' . _x('Krona', 'Currency Symbol', 'arc-core'),
                    'lira' => '&#8356; ' . _x('Lira', 'Currency Symbol', 'arc-core'),
                    'peso' => '&#8369; ' . _x('Peso', 'Currency Symbol', 'arc-core'),
                    'pound' => '&#163; ' . _x('Pound Sterling', 'Currency Symbol', 'arc-core'),
                    'real' => 'R$ ' . _x('Real', 'Currency Symbol', 'arc-core'),
                    'ruble' => '&#8381; ' . _x('Ruble', 'Currency Symbol', 'arc-core'),
                    'indian_rupee' => '&#8377; ' . _x('Rupee (Indian)', 'Currency Symbol', 'arc-core'),
                    'shekel' => '&#8362; ' . _x('Shekel', 'Currency Symbol', 'arc-core'),
                    'won' => '&#8361; ' . _x('Won', 'Currency Symbol', 'arc-core'),
                    'yen' => '&#165; ' . _x('Yen/Yuan', 'Currency Symbol', 'arc-core'),
                    'custom' => __('Custom', 'arc-core'),
                ],
                'default' => 'dollar',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Custom Symbol', 'arc-core'),
                'type' => Controls_Manager::TEXT,
                'condition' => [
                    'currency' => 'custom',
                ],
        ...
        $this->add_control(
            ''. $control_id .'_period',
            [
                'label' => __('Period', 'arc-core'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Per Month', 'arc-core'),
                'dynamic' => [
                    'active' => true
                ]
            ]
    ...
    protected function nilos_product_layout($control_id = null, $control_name = null){
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Product Offer', 'arc-core'),
                    'layout-2' => esc_html__('Product Simple', 'arc-core'),
                    'layout-3' => esc_html__('Product Arrival', 'arc-core'),
                    'layout-4' => esc_html__('Product SM List', 'arc-core'),
                    'layout-5' => esc_html__('Product Slider Trending', 'arc-core'),
                    'layout-6' => esc_html__('Product Weeks Featured', 'arc-core'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        if(false){
            ...
            'nilos_'. $control_id .'__slides_per_view',
             [
                'label'       => esc_html__( 'Slides Per View', 'arc-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( '3', 'arc-core' ),
                'placeholder' => esc_html__( 'Your Number', 'arc-core' ),
                'condition' => [
                    'nilos_design_style' => ['layout-1']
                ]
             ]
            ...
            'nilos_'. $control_id .'__slides_per_view_lg',
             [
                'label'       => esc_html__( 'Slides Per View In LG (992px)', 'arc-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( '2', 'arc-core' ),
                'placeholder' => esc_html__( 'Your Number', 'arc-core' ),
                'condition' => [
                    'nilos_design_style' => ['layout-1']
                ]
            ...
            'nilos_'. $control_id .'__slides_per_view_md',
             [
                'label'       => esc_html__( 'Slides Per View In MD (768px)', 'arc-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( '2', 'arc-core' ),
                'placeholder' => esc_html__( 'Your Number', 'arc-core' ),
                'condition' => [
            ...
            'nilos_'. $control_id .'__slides_per_view_sm',
             [
                'label'       => esc_html__( 'Slides Per View In SM (576px)', 'arc-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( '1', 'arc-core' ),
                'placeholder' => esc_html__( 'Your Number', 'arc-core' ),
                'condition' => [
                    'nilos_design_style' => ['layout-1']
                ]
            ...
            'nilos_'. $control_id .'__slides_per_view_xs',
             [
                'label'       => esc_html__( 'Slides Per View In XS (0-575px)', 'arc-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( '1', 'arc-core' ),
                'placeholder' => esc_html__( 'Your Number', 'arc-core' ),
                'condition' => [
    ...
    protected function nilos_product_badges(){
        $this->start_controls_section(
            'nilos_product_badge_sec',
               [
                 'label' => esc_html__( 'Badge Controls', 'arc-core' ),
                 'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
               ]
           );
           ...
           $this->add_control(
            'product_trending_badge_enable',
              [
                 'label'        => esc_html__( 'Enable Trending Badge ?', 'arc-core' ),
                 'type'         => \Elementor\Controls_Manager::SWITCHER,
                 'label_on'     => esc_html__( 'Show', 'arc-core' ),
                 'label_off'    => esc_html__( 'Hide', 'arc-core' ),
                 'return_value' => 'yes',
           ...
           $this->add_control(
               'product_badge_type',
              [
                 'label'   => esc_html__( 'Product Badge Type', 'arc-core' ),
                 'type' => \Elementor\Controls_Manager::SELECT,
                 'options' => [
                       'sales'  => esc_html__( 'Based On Sales', 'arc-core' ),
                       'rating'  => esc_html__( 'Based On Rating', 'arc-core' ),
                       'review'  => esc_html__( 'Based On Review', 'arc-core' ),
                       'views'  => esc_html__( 'Based On Views', 'arc-core' ),
                    ],
                 'default' => 'sales',
                 'condition' => [
           ...
           'sale_count_to_show',
            [
              'label'       => esc_html__( 'Sales Count', 'arc-core' ),
              'type'        => \Elementor\Controls_Manager::TEXT,
              'default'     => esc_html__( '10', 'arc-core' ),
              'placeholder' => esc_html__( 'Count Number', 'arc-core' ),
              'description' => esc_html__( 'How many sales are required to show it', 'arc-core' ),
              'condition' => [
           ...
           'rating_count_to_show',
            [
              'label'       => esc_html__( 'Rating Count', 'arc-core' ),
              'type'        => \Elementor\Controls_Manager::TEXT,
              'default'     => esc_html__( '5', 'arc-core' ),
              'placeholder' => esc_html__( 'Rating Count Number', 'arc-core' ),
              'description' => esc_html__( 'How many ratings are required to show it', 'arc-core' ),
              'condition' => [
           ...
           'review_count_to_show',
            [
              'label'       => esc_html__( 'Reviews Count', 'arc-core' ),
              'type'        => \Elementor\Controls_Manager::TEXT,
              'default'     => esc_html__( '3', 'arc-core' ),
              'placeholder' => esc_html__( 'Review Count', 'arc-core' ),
              'description' => esc_html__( 'How many reviews are required to show it', 'arc-core' ),
              'condition' => [
           ...
           'view_count_to_show',
            [
              'label'       => esc_html__( 'Views Count', 'arc-core' ),
              'type'        => \Elementor\Controls_Manager::TEXT,
              'default'     => esc_html__( '10', 'arc-core' ),
              'placeholder' => esc_html__( 'Views Count', 'arc-core' ),
              'description' => esc_html__( 'How many views are required to show it', 'arc-core' ),
              'condition' => [
           ...
           $this->add_control(
              'product_hot_badge_enable',
                 [
                    'label'        => esc_html__( 'Enable Hot Badge?', 'arc-core' ),
                    'type'         => \Elementor\Controls_Manager::SWITCHER,
                    'label_on'     => esc_html__( 'Show', 'arc-core' ),
                    'label_off'    => esc_html__( 'Hide', 'arc-core' ),
                    'return_value' => 'yes',
              ...
              $this->add_control(
                 'date_diff_to_show',
                 [
                    'label'       => esc_html__( 'Date Count', 'arc-core' ),
                    'type'        => \Elementor\Controls_Manager::TEXT,
                    'default'     => esc_html__( '10', 'arc-core' ),
                    'placeholder' => esc_html__( 'Date Count', 'arc-core' ),
                    'description' => esc_html__( 'How many days from uploaded are going to showing it.', 'arc-core' ),
                    'condition' => [
    ...
    protected function nilos_post_result_count($query, $settings = null){
        ...
        // var_dump($current);
        if ( 1 === intval( $total ) ) {
              _e( 'Showing the single result', 'arc-core' );
        } elseif ( $total <= $per_page || -1 === $per_page ) {
              /* translators: %d: total results */
              printf( _n( 'Showing all %d result', 'Showing all %d results', $total, 'arc-core' ), $total );
        } else {
              ...
              printf( _nx( 'Showing %1$d&ndash;%2$d of %3$d result', 'Showing %1$d&ndash;%2$d of %3$d results', $total, 'with first and last result', 'arc-core' ), $first, $last, $total );
        }
