...
class NILOS_Newsletter extends Widget_Base {
	...
	public function get_title() {
		return __( 'NILOS Newsletter', 'arc-core' );
	}
    ...
    protected function register_controls_section(){
		...
		$this->start_controls_section(
		 'nilos_text_sec',
			 [
			   'label' => esc_html__( 'Title & Description', 'arc-core' ),
		...
		'nilos_text_title',
            [
                ...
                'default'     => esc_html__( 'Subscribe our Newsletter', 'arc-core' ),
        ...
        'nilos_text_subtitle',
         [
            ...
            'type'        => \Elementor\Controls_Manager::TEXT,
            'default'     => esc_html__( 'Sale 20% off all store ', 'arc-core' ),
        ...
        $this->add_control(
         ...
         [
           'label'        => esc_html__( 'Enable BG Shape', 'arc-core' ),
        ...
        $this->add_control(
         'nilos_man_shape',
         [
           'label'        => esc_html__( 'Enable Man Shape', 'arc-core' ),
           'type'         => \Elementor\Controls_Manager::SWITCHER,
           'label_on'     => esc_html__( 'Show', 'arc-core' ),
           'label_off'    => esc_html__( 'Hide', 'arc-core' ),
           'return_value' => 'yes',
        ...
        $this->start_controls_section(
         'nilos_subscribe_form_sec',
             [
               'label' => esc_html__( 'Form Control', 'arc-core' ),
               'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
             ]
        );
