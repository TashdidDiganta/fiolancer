...
class NILOS_Blog_Post extends Widget_Base {
	...
	protected function register_controls_section() {
        ...
        $this->add_control(
            '_blog_style',
            [
                'label' => esc_html__('Blog Style', 'arc-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXTAREA,
                'default' => esc_html__('Company Insights', 'arc-core'),
                ...
                ?>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="news-one__single">
                            ...
                            <a href="<?php the_permalink(); ?>" class="news-one__read-more"><?php esc_html_e('Read More', 'arc-core'); ?></a>
                        </div>
                    </div>
                    <!--News One Single End-->
