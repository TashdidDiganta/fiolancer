...
class NILOS_Footer_Call extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Footer Call', 'arc-core' );
    }
    ...
    protected function register_controls_section() {
        ...
        $this->start_controls_section(
            'nilos_footer_call_sec',
                [
                  'label' => esc_html__( 'Footer Call', 'arc-core' ),
           ...
           'nilos_footer_call_subtitle',
            [
               ...
               'default'     => esc_html__( 'Got Questions? Call us', 'arc-core' ),
           ...
           $repeater = new \Elementor\Repeater();
            ...
            $this->add_control(
              ...
              [
                'label'       => esc_html__( 'Call Repeater', 'arc-core' ),
                'type'        => \Elementor\Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                  [
                    'nilos_footer_call_title'   => esc_html__( '012 458 246', 'arc-core' ),
                  ],
                ],
