...
class NILOS_Breadcrumb extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Nilos Breadcrumb', 'arc-core' );
    }
    ...
    protected function register_controls_section(){
        ...
        'nilos_breadcrumb_subtitle',
         [
            'label'       => esc_html__( 'Breadcrumb Subtitle', 'arc-core' ),
        ...
        'nilos_breadcrumb_title',
         [
            'label'       => esc_html__( 'Breadcrumb Title', 'arc-core' ),
            'type'        => \Elementor\Controls_Manager::TEXT,
            'default'     => esc_html__( 'The Page Title', 'arc-core' ),
            'placeholder' => esc_html__( 'Your Text', 'arc-core' ),
            'label_block' => true
         ]
        );
        ...
        $this->add_control(
			'nilos_image',
			[
				'label' => esc_html__( 'Breadcrumb Bg', 'arc-core' ),
            ...
            <div class="container">
                <div class="page-header__inner">
                    <ul class="thm-breadcrumb list-unstyled">
                        <li><a href="<?php echo home_url(); ?>"><?php esc_html_e('Home', 'arc-core'); ?></a></li>
                        <li><span>/</span></li>
