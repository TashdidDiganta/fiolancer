...
class NILOS_Instagram_Post extends Widget_Base {
	...
	public function get_title() {
		return __( 'Instagram Post', 'arc-core' );
	}
	...
	protected function register_controls_section() {
		...
		$this->start_controls_section(
            ...
            [
                'label' => __( 'Instagram Slider', 'arc-core' ),
		...
		$repeater->add_control(
		 'nilos_insta_banner',
		 [
		   'label'        => esc_html__( 'Is Instagram Banner?', 'arc-core' ),
		 ...
		 'nilos_insta_banner_subtitle',
		  [
			 ...
			 'default'     => esc_html__( 'Follow Us on', 'arc-core' ),
		 ...
		 'nilos_insta_banner_follow_link_text',
		  [
			 ...
			 'type'        => \Elementor\Controls_Manager::TEXT,
			 'default'     => esc_html__( 'Instagram', 'arc-core' ),
			 'placeholder' => esc_html__( 'Your Text', 'arc-core' ),
			 'label_block' => true,
			 'condition' => [
				'repeater_condition' => ['style_2'],
		 ...
		 $repeater->add_control(
		  'nilos_image',
			[
				'label'   => esc_html__( 'Upload Image', 'arc-core' ),
				'type'    => \Elementor\Controls_Manager::MEDIA,
				'default' => [
					'url' => \Elementor\Utils::get_placeholder_image_src(),
				],
		 ...
		 $repeater->add_control(
		  'nilos_insta_link',
		  [
			'label'   => esc_html__( 'Instagram Link', 'arc-core' ),
			...
			'default'     => [
			  ...
			  'placeholder' => esc_html__( 'Your Link Here', 'arc-core' ),
			  'label_block' => true,
			]
		  );
		 ...
		 $this->add_control(
		   'nilos_insta_list',
		   [
			 'label'       => esc_html__( 'Instagram List', 'arc-core' ),
			 'type'        => \Elementor\Controls_Manager::REPEATER,
			 'fields'      => $repeater->get_controls(),
			 'default'     => [
			   [
				 'nilos_insta_title'   => esc_html__( 'Image 1', 'arc-core' ),
			   ],
			   [
				 'nilos_insta_title'   => esc_html__( 'Image 2', 'arc-core' ),
			   ],
			   [
				 'nilos_insta_title'   => esc_html__( 'Image 3', 'arc-core' ),
			   ],
			   [
				 'nilos_insta_title'   => esc_html__( 'Image 4', 'arc-core' ),
			   ],
			 ],
