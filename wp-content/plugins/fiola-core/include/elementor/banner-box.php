...
class NILOS_Banner_Box extends Widget_Base {
    ...
    protected function register_controls_section(){
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'layout-2' => esc_html__('Layout 2', 'arc-core'),
                    'layout-3' => esc_html__('Layout 3', 'arc-core'),
                    'layout-4' => esc_html__('Layout 4', 'arc-core'),
                    'layout-5' => esc_html__('Layout 5', 'arc-core'),
                    'layout-6' => esc_html__('Layout 6', 'arc-core'),
                    'layout-7' => esc_html__('Layout 7', 'arc-core'),
                    'layout-8' => esc_html__('Layout 8', 'arc-core'),
                    'layout-9' => esc_html__('Layout 9', 'arc-core'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->start_controls_section(
         'nilos_banner_sec',
             [
               'label' => esc_html__( 'Title & Content', 'arc-core' ),
        ...
        $this->add_control(
         'is_brown_style',
         [
           'label'        => esc_html__( 'Enable Brown Style?', 'arc-core' ),
        ...
        'nilos_banner_subtitle',
            [
                'label'       => esc_html__( 'Banner Subtitle', 'arc-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( 'Women', 'arc-core' ),
        ...
        'nilos_banner_title',
         [
            'label'       => esc_html__( 'Banner Title', 'arc-core' ),
            'type'        => \Elementor\Controls_Manager::TEXT,
            'default'     => esc_html__( 'NILOSp Blouse Shirts', 'arc-core' ),
            'placeholder' => esc_html__( 'Your Text', 'arc-core' ),
            'label_block' => true
         ]
        );
        ...
        $this->add_control(
         'nilos_banner_url',
         [
           'label'   => esc_html__( 'Banner Title URL', 'arc-core' ),
           ...
           'default'     => [
             ...
             'placeholder' => esc_html__( 'Your URL', 'arc-core' ),
             'label_block' => true,
           ]
         );
         ...
         $this->add_control(
          ...
          [
            'label'        => esc_html__( 'Enable Square Style?', 'arc-core' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     => esc_html__( 'Show', 'arc-core' ),
            'label_off'    => esc_html__( 'Hide', 'arc-core' ),
            'return_value' => 'yes',
		...
		$this->start_controls_section(
            '_nilos_image',
            [
                'label' => esc_html__('Thumbnail', 'arc-core'),
            ]
        );
        $this->add_control(
            'nilos_image',
