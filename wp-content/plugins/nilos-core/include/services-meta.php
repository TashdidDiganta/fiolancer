...
function nilos_iconpicker_admin_scripts() {
    wp_register_script('arc-iconpicker', plugins_url( 'js/icon-picker.js', __FILE__ ), false, '1.0');
    wp_register_style('arc-iconpicker', plugins_url( 'css/icon-picker.css', __FILE__ ), false, '1.0');
    ...
    <div class="et_menu_options">
        <div class="nilos-field-elementor-template description description-wide">
            <label for="menu_item_elementor-template-<?php echo esc_attr($item_id); ?>">
                <?php esc_html_e( 'Elementor Template', 'arc-core'  ); ?><br />
                ...
                name="menu_item_elementor_template[<?php echo esc_attr($item_id); ?>]">
                    <option value="-1"><?php echo esc_html__('Select A Template', 'arc-core') ?></option>
