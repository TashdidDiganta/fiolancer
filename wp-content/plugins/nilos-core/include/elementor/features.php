...
class NILOS_Features extends Widget_Base {
	...
	protected function register_controls_section() {
        ...
        $this->start_controls_section(
            'nilos_features',
            [
                'label' => esc_html__('Features List', 'arc-core'),
                'description' => esc_html__( 'Control all the style settings from Style tab', 'arc-core' ),
        ...
        $repeater->add_control(
            'nilos_features_title', [
                ...
                'default' => esc_html__('Service Title', 'arc-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'nilos_features_title' => esc_html__('Business Stratagy', 'arc-core'),
                    ],
                    [
                        'nilos_features_title' => esc_html__('Website Development', 'arc-core')
                    ],
                    [
                        'nilos_features_title' => esc_html__('Marketing & Reporting', 'arc-core')
                    ]
                ],
