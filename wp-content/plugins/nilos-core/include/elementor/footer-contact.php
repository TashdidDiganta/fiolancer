...
class NILOS_Footer_Contact extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Footer Contact', 'arc-core' );
    }
    ...
    protected function register_controls_section() {
        ...
        $this->start_controls_section(
            'nilos_footer_contact',
                [
                  'label' => esc_html__( 'Footer Contact Info', 'arc-core' ),
         ...
         if (nilos_is_elementor_version('<', '2.6.0')) {
            ...
            'nilos_footer_contact_title',
              [
                ...
                'default'     => esc_html__( 'Contact Title', 'arc-core' ),
                'label_block' => true,
              ]
            );
            ...
            $repeater->add_control(
               'nilos_contact_type',
               [
                 'label'   => esc_html__( 'Select Type', 'arc-core' ),
                 'type' => \Elementor\Controls_Manager::SELECT,
                 'options' => [
                   'email'  => esc_html__( 'Email', 'arc-core' ),
                   'phone'  => esc_html__( 'Phone', 'arc-core' ),
                   'map'  => esc_html__( 'Map', 'arc-core' ),
                   'default'  => esc_html__( 'Default', 'arc-core' ),
                 ],
                 'default' => 'default',
               ]
              );
              ...
              $repeater->add_control(
               ...
               [
                 'label'   => esc_html__( 'Default URL', 'arc-core' ),
              ...
              $repeater->add_control(
               ...
               [
                 'label'   => esc_html__( 'Phone URL', 'arc-core' ),
                 'type'        => \Elementor\Controls_Manager::URL,
                 'default'     => [
                     'url'               => '#',
                     'is_external'       => true,
              ...
              $repeater->add_control(
               ...
               [
                 'label'   => esc_html__( 'Email URL', 'arc-core' ),
                 'type'        => \Elementor\Controls_Manager::URL,
                 'default'     => [
                     'url'               => '#',
                     'is_external'       => true,
            ...
            $this->add_control(
              ...
              [
                'label'       => esc_html__( 'Contact Repeater', 'arc-core' ),
                'type'        => \Elementor\Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                  [
                    'nilos_footer_contact_title'   => esc_html__( 'nilos@mail.com', 'arc-core' ),
                  ],
                  [
                    'nilos_footer_contact_title'   => esc_html__( '+012 456 5852', 'arc-core' ),
                  ],
                ],
