...
class NILOS_Author_Quote extends Widget_Base {
	...
	public function get_title() {
		return __( 'NILOS Author Quote', 'arc-core' );
	}
    ...
    protected function register_controls_section(){
		...
		$this->start_controls_section(
		 'nilos_author_quote_sec',
			 [
			   'label' => esc_html__( 'Author Info', 'arc-core' ),
        ...
        $this->add_control(
         'nilos_author_thumb',
         [
           'label'   => esc_html__( 'Upload Author Image', 'arc-core' ),
		...
		'nilos_author_name',
            [
                'label'       => esc_html__( 'Author Name', 'arc-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( 'Theodore Handle', 'arc-core' ),
                'placeholder' => esc_html__( 'Your Title', 'arc-core' ),
                'label_block' => true
            ]
		);
		$this->add_control(
		'nilos_author_designation',
            [
                'label'       => esc_html__( 'Author Designation', 'arc-core' ),
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( ' UI/UX design ', 'arc-core' ),
                'placeholder' => esc_html__( 'Your Title', 'arc-core' ),
                'label_block' => true
            ]
		);
		...
		$this->add_control(
         'nilos_author_quote',
         [
           'label'       => esc_html__( 'Author Quote Text', 'arc-core' ),
           'type'        => \Elementor\Controls_Manager::TEXTAREA,
           'rows'        => 10,
           'default'     => esc_html__( 'We work with top suppliers and manufacturers to ensure that every item we ', 'arc-core' ),
        ...
        $this->add_control(
         ...
         [
           'label'        => esc_html__( 'Enable Shape ?', 'arc-core' ),
        ...
        $this->add_control(
         ...
         [
           'label'   => esc_html__( 'Upload Background Image', 'arc-core' ),
           'type'    => \Elementor\Controls_Manager::MEDIA,
             'default' => [
               'url' => \Elementor\Utils::get_placeholder_image_src(),
           ],
		...
		$this->start_controls_section(
		 'nilos_brand_sec',
			 [
			   'label' => esc_html__( 'Brand List', 'arc-core' ),
			   'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			 ]
		);
		...
		'nilos_brand_title',
		  [
			'label'   => esc_html__( 'Brand Title', 'arc-core' ),
			'type'        => \Elementor\Controls_Manager::TEXT,
			'default'     => esc_html__( 'Brand', 'arc-core' ),
			'label_block' => true,
		  ]
		);
        ...
        $repeater->add_control(
         'nilos_brand_image',
         [
           'label'   => esc_html__( 'Upload Brand Image', 'arc-core' ),
           'type'    => \Elementor\Controls_Manager::MEDIA,
             'default' => [
               'url' => \Elementor\Utils::get_placeholder_image_src(),
           ],
		...
		$this->add_control(
		  ...
		  [
			...
			'default'     => [
			  [
				'nilos_brand_title'   => esc_html__( 'Brand Image', 'arc-core' ),
			  ],
			  [
				'nilos_brand_title'   => esc_html__( 'Brand Image', 'arc-core' ),
			  ],
