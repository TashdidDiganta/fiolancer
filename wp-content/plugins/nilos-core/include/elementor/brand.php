	...
	protected function register_controls_section() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'label' => __( 'URL', 'arc-core' ),
                'default' => __( '#', 'arc-core' ),
                'placeholder' => __( 'Type url here', 'arc-core' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'title_field' => esc_html__( 'Brand Item', 'arc-core' ),
                'default' => [
                    [
                        'nilos_brand_image' => [
                            'url' => Utils::get_placeholder_image_src(),
