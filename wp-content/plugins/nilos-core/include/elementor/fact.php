...
class NILOS_Fact extends Widget_Base {
	...
	protected function register_controls_section() {
        ...
        $this->start_controls_section(
            'nilos_fact',
            [
                'label' => esc_html__('Fact List', 'arc-core'),
        ...
        $repeater->add_control(
            'nilos_fact_number', [
                'label' => esc_html__('Number', 'arc-core'),
                'description' => nilos_get_allowed_html_desc( 'basic' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('17', 'arc-core'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'nilos_fact_number_unit', [
                'label' => esc_html__('Number Quantity', 'arc-core'),
                'description' => nilos_get_allowed_html_desc( 'basic' ),
                'type' => \Elementor\Controls_Manager::TEXT,
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => esc_html__('Food', 'arc-core'),
                'label_block' => true,
            ]
        );             
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'nilos_fact_title' => esc_html__('Business', 'arc-core'),
                    ],
                    [
                        'nilos_fact_title' => esc_html__('Website', 'arc-core')
                    ],
                    [
                        'nilos_fact_title' => esc_html__('Marketing', 'arc-core')
                    ]
                ],
